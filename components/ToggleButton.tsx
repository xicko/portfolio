...
const ProjectSwitch: React.FC<ProjectSwitchProps> = ({
  ...
  return (
    <div className="flex flex-col items-center">
      <div className='flex flex-row shrink grow cursor-pointer space-x-4 mb-8'>
      <button
        type="button"
        className={`
      ...
      >
        ...
        <span className="absolute -z-40 -mt-2 w-[145px] h-[46px] rounded-lg bg-[#D7E0FF] transform transition duration-300 ease-in-out"
          style={{
            transform: selectedProject === 'web' ? 'translateX(-10%)' : 'translateX(90%)',
          }}
        />
        <span className="absolute -z-50 mt-[-8px] w-[290px] h-[46px] rounded-lg bg-[#172a36] bg-opacity-20"
          style={{
